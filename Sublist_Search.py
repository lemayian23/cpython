...
node_list.next.next.next.next= Node(3)
node_list.next.next.next.next.next = Node(6)
node_list.next.next.next.next.next.next = Node(7)
node_list.next.next.next.next.next.next.next = Node(0)
